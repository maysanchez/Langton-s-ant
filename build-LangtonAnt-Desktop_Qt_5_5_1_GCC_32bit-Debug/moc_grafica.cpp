...
QT_MOC_LITERAL(1, 8, 14), // "on_img_clicked"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "grafica\0on_img_clicked\0"
};
...
void grafica::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        grafica *_t = static_cast<grafica *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject grafica::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_grafica.data,
      qt_meta_data_grafica,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
