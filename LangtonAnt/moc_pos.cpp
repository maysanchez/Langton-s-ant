...
struct qt_meta_stringdata_Pos_t {
    QByteArrayData data[3];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Pos_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Pos_t qt_meta_stringdata_Pos = {
    {
QT_MOC_LITERAL(0, 0, 3), // "Pos"
...
const QMetaObject Pos::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Pos.data,
      qt_meta_data_Pos,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Pos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Pos.stringdata0))
